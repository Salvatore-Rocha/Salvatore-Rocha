...
👀 _**Note**_ 👀: _The Dash apps are hosted on Render's free tier, which will spin them down during inactivity. This can cause delays of 50 seconds or more for requests/loading, so please be patient.🥺 Alternatively, you can click directly on the repository links to get an overview of the project._  
